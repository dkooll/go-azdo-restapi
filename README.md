...
## Description
This code creates an agent pool in Azure DevOps. It first checks if it is already exists by sending a GET request to the Azure DevOps API, then it will send a POST request to create the pool if it does not exist.
